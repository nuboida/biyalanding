...
const MainAbout = () => {
  return (
    <>
      <div className="mb-20">
        <div className="bg-[url('/about-bg.png')] px-4 sm:px-36 bg-cover min-h-screen flex items-center">
          <div className="flex flex-col lg:flex-row justify-between items-center container-xl pt-20 lg:pt-0">
            <div className="pb-10 w-full lg:w-1/2 flex flex-col justify-between gap-5 text-center lg:text-left">
              <h1 className="text-6xl lg:text-9xl font-mono">What is Biyabot</h1>
        ...
        <div className="bg-primary py-20">
          <div className="flex flex-col items-center text-center px-4">
            <h1 className="text-6xl lg:text-9xl font-mono">How We Make Life Easier</h1>
