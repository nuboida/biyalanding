    ...
    <section className="my-20">
      <div className="px-10 mb-10">
        <div className="flex justify-center">
          <h1 className="font-mono text-9xl">How we help your Business</h1>
        </div>
      </div>
      <div className="px-20">
        <div className="bg-[#E8E9EF] flex justify-between items-center px-10 pt-5">
          <div className="w-1/2">
      ...
      <div className="px-20 my-20">
        <div className="bg-primary flex justify-between items-center px-10 pt-5">
          <div className="w-1/2">
            <div className="flex flex-col w-11/12 pl-14">
              <div>
